...
//mongoose.connect('mongodb+srv://'+process.env.MONGODB_USER+':'+process.env.MONGODB_PASS+'@'+process.env.MONGODB_HOST+':'+process.env.MONGODB_PORT+'/'+process.env.MONGODB_DB);
...
app.use(session({
  ...
  store: MongoStore.create({ mongoUrl: uri }) //process.env.MONGODB_URI
}));
